...
const _sfc_main$4 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative w-full background-medium pb-12 lg:pb-0 z-20" }, _attrs))} data-v-982f2833><div class="absolute inset-0 z-0 pointer-events-none overflow-hidden background-medium" data-v-982f2833><div class="absolute -left-20 -top-20 w-[600px] h-full opacity-[0.03] text-primary rotate-12" data-v-982f2833><svg viewBox="0 0 600 800" fill="currentColor" data-v-982f2833><path d="M100 100L500 300V450L100 250V100Z" data-v-982f2833></path><path d="M50 350L450 550V700L50 500V350Z" opacity="0.6" data-v-982f2833></path></svg></div></div><div class="flex flex-col lg:flex-row min-h-[50vh] items-stretch relative" data-v-982f2833><div class="w-full lg:w-1/2 flex items-center p-10 lg:pl-[5%] lg:pr-16 relative" data-v-982f2833><div class="absolute -left-12 -top-12 text-[200px] sf-bold text-gray-900 opacity-[0.02] pointer-events-none select-none" data-v-982f2833>VISION</div><div class="absolute top-0 right-0 w-32 h-32 bg-primary/5 blur-3xl pointer-events-none" data-v-982f2833></div><div class="max-w-xl relative z-10" data-v-982f2833><div class="flex items-center gap-4 mb-6" data-v-982f2833><div class="h-[2px] w-12 bg-primary" data-v-982f2833></div><span class="text-xs sf-bold uppercase tracking-[0.4em] text-primary" data-v-982f2833>Nuestra Visión</span></div><h2 class="text-4xl lg:text-6xl font-black text-primary uppercase tracking-tighter leading-tight mb-6" data-v-982f2833> Socio Estratégico <br data-v-982f2833> Técnico </h2><div class="space-y-4 text-primary sf-light leading-relaxed text-base" data-v-982f2833><p data-v-982f2833> En <span class="text-primary font-black" data-v-982f2833>StahlForm</span> no solo fabricamos; co-creamos soluciones. Entendemos que la continuidad operativa de nuestros clientes depende de la <span class="text-primary font-black italic" data-v-982f2833>precisión</span> mecánica. </p><p data-v-982f2833> Aliado estratégico que aporta <span class="text-primary font-black" data-v-982f2833>ingeniería aplicada</span> y una robusta infraestructura tecnológica para la gran minería. </p></div><div class="mt-12 grid grid-cols-2 gap-6 relative z-30" data-v-982f2833><div class="bg-primary p-6 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.1)] border border-white/20 flex flex-col items-center text-center transition-transform hover:-translate-y-2" data-v-982f2833><p class="text-accent text-4xl lg:text-5xl mb-2 tracking-tighter font-black" data-v-982f2833>15+</p><p class="text-[9px] uppercase tracking-widest sf-bold text-white/80" data-v-982f2833>Años de<br data-v-982f2833>Experiencia</p></div><div class="bg-primary p-6 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.1)] border border-white/20 flex flex-col items-center text-center transition-transform hover:-translate-y-2" data-v-982f2833><p class="text-accent text-4xl lg:text-5xl mb-2 tracking-tighter font-black" data-v-982f2833>100%</p><p class="text-[9px] uppercase tracking-widest sf-bold text-white/80" data-v-982f2833>Trazabilidad<br data-v-982f2833>Técnica</p></div></div></div></div><div class="hidden lg:block w-full lg:w-1/2 relative min-h-[350px] lg:min-h-auto" data-v-982f2833><div class="absolute inset-0 bg-secondary/10 z-10 pointer-events-none" data-v-982f2833></div><img${ssrRenderAttr("src", unref(_imports_0))} alt="Industrial Workshop StahlForm" class="w-full h-full object-cover contrast-110 brightness-95" data-v-982f2833><div class="absolute top-0 left-0 w-32 h-full bg-gradient-to-r from-[var(--background-medium)] to-transparent hidden lg:block z-20 pointer-events-none" data-v-982f2833></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-982f2833"]]);
const _sfc_main$3 = {
...
//# sourceMappingURL=nuestra-empresa-Dj25dvT-.mjs.map
