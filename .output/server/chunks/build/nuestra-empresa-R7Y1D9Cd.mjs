...
import { _ as _imports_0$1 } from './Torno_03-ZI2nDTS5.mjs';
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative w-full background-medium pb-12 lg:pb-0 z-20" }, _attrs))} data-v-b00fd7ce><div class="absolute inset-0 z-0 pointer-events-none overflow-hidden background-medium" data-v-b00fd7ce><div class="absolute -left-20 -top-20 w-[600px] h-full opacity-[0.03] text-primary rotate-12" data-v-b00fd7ce><svg viewBox="0 0 600 800" fill="currentColor" data-v-b00fd7ce><path d="M100 100L500 300V450L100 250V100Z" data-v-b00fd7ce></path><path d="M50 350L450 550V700L50 500V350Z" opacity="0.6" data-v-b00fd7ce></path></svg></div></div><div class="flex flex-col lg:flex-row min-h-[50vh] items-stretch relative" data-v-b00fd7ce><div class="w-full lg:w-1/2 flex items-center p-10 lg:pl-[5%] lg:pr-16 relative" data-v-b00fd7ce><div class="absolute -left-12 -top-12 text-[200px] sf-bold text-gray-900 opacity-[0.02] pointer-events-none select-none" data-v-b00fd7ce>VISION</div><div class="absolute top-0 right-0 w-32 h-32 bg-primary/5 blur-3xl pointer-events-none" data-v-b00fd7ce></div><div class="max-w-xl relative z-10" data-v-b00fd7ce><div class="flex items-center gap-4 mb-6" data-v-b00fd7ce><div class="h-[2px] w-12 bg-primary" data-v-b00fd7ce></div><span class="text-xs sf-bold uppercase tracking-[0.4em] text-primary" data-v-b00fd7ce>Nuestra Visión</span></div><h2 class="text-4xl lg:text-6xl sf-bold text-secondary uppercase tracking-tighter leading-tight mb-6" data-v-b00fd7ce> Socio Estratégico <br data-v-b00fd7ce><span class="text-accent italic" data-v-b00fd7ce>Técnico</span></h2><div class="space-y-4 text-gray-600 sf-light leading-relaxed text-base" data-v-b00fd7ce><p data-v-b00fd7ce> En <span class="text-accent sf-bold" data-v-b00fd7ce>StahlForm</span> no solo fabricamos; co-creamos soluciones. Entendemos que la continuidad operativa de nuestros clientes depende de la <span class="text-accent sf-bold italic" data-v-b00fd7ce>precisión</span> mecánica. </p><p data-v-b00fd7ce> Aliado estratégico que aporta <span class="text-accent sf-bold" data-v-b00fd7ce>ingeniería aplicada</span> y una robusta infraestructura tecnológica para la gran minería. </p></div><div class="mt-12 grid grid-cols-2 gap-6 relative z-30" data-v-b00fd7ce><div class="background-medium p-6 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.1)] border border-white/20 flex flex-col items-center text-center transition-transform hover:-translate-y-2" data-v-b00fd7ce><p class="text-primary text-4xl lg:text-5xl mb-2 tracking-tighter sf-bold" data-v-b00fd7ce>15+</p><p class="text-[9px] uppercase tracking-widest sf-bold text-gray-400" data-v-b00fd7ce>Años de<br data-v-b00fd7ce>Experiencia</p></div><div class="background-medium p-6 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.1)] border border-white/20 flex flex-col items-center text-center transition-transform hover:-translate-y-2" data-v-b00fd7ce><p class="text-primary text-4xl lg:text-5xl mb-2 tracking-tighter sf-bold" data-v-b00fd7ce>100%</p><p class="text-[9px] uppercase tracking-widest sf-bold text-gray-400" data-v-b00fd7ce>Trazabilidad<br data-v-b00fd7ce>Técnica</p></div></div></div></div><div class="hidden lg:block w-full lg:w-1/2 relative min-h-[350px] lg:min-h-auto" data-v-b00fd7ce><div class="absolute inset-0 bg-secondary/10 z-10 pointer-events-none" data-v-b00fd7ce></div><img${ssrRenderAttr("src", unref(_imports_0))} alt="Industrial Workshop StahlForm" class="w-full h-full object-cover contrast-110 brightness-95" data-v-b00fd7ce><div class="absolute top-0 left-0 w-32 h-full bg-gradient-to-r from-[var(--background-medium)] to-transparent hidden lg:block z-20 pointer-events-none" data-v-b00fd7ce></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-b00fd7ce"]]);
const _sfc_main$3 = {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative w-full bg-accent py-10 lg:py-20 overflow-hidden font-sans border-none" }, _attrs))}><div class="absolute inset-0 z-0 pointer-events-none opacity-[0.25] mix-blend-multiply"><img${ssrRenderAttr("src", unref(_imports_0$1))} alt="Industrial Machine Background" class="w-full h-full object-cover grayscale contrast-125"></div><div class="absolute -right-40 -bottom-40 w-[900px] h-full z-0 opacity-15 pointer-events-none transform rotate-45"><svg viewBox="0 0 900 1200" fill="none" xmlns="http://www.w3.org/2000/svg" class="text-primary w-full h-full"><path d="M100 300L800 700V900L100 500V300Z" fill="currentColor"></path><path d="M100 700L800 1100V1300L100 900V700Z" fill="currentColor" opacity="0.6"></path></svg></div><div class="custom-container relative z-10"><div class="text-center mb-10 lg:mb-20 px-4"><h2 class="text-4xl lg:text-6xl sf-bold text-primary uppercase tracking-tighter mb-4 leading-tight"> Desafíos <span class="text-primary italic">Operacionales</span></h2><p class="text-[10px] uppercase tracking-[0.6em] text-light sf-bold">Identificación y Solución de Cuellos de Botella Críticos</p></div><div class="flex flex-col lg:flex-row gap-8 lg:gap-12 items-stretch"><div class="w-full lg:w-1/2 bg-white/10 backdrop-blur-md p-10 lg:p-16 rounded-3xl border border-white/20 hover:bg-white/20 transition-all relative group shadow-xl"><div class="absolute top-0 right-0 p-8"><svg class="w-12 h-12 text-primary/10 group-hover:text-primary/20 transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L1 21h22L12 2zm0 3.45L20.22 19H3.78L12 5.45zM11 16h2v2h-2v-2zm0-7h2v5h-2V9z"></path></svg></div><h3 class="text-xl sf-bold text-primary uppercase tracking-widest mb-10 border-b border-primary/20 pb-4 inline-block">Impactos Críticos</h3><div class="space-y-12"><div class="flex items-start gap-6"><div class="w-10 h-10 rounded bg-primary/10 flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><div><h4 class="text-primary sf-bold uppercase tracking-widest mb-2 text-sm">Fallas No Programadas</h4><p class="text-xs text-secondary leading-relaxed">Costos de detención que pueden superar los USD $50,000 por hora en plantas de alta producción.</p></div></div><div class="flex items-start gap-6"><div class="w-10 h-10 rounded bg-primary/10 flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg></div><div><h4 class="text-primary sf-bold uppercase tracking-widest mb-2 text-sm">Desgaste Acelerado</h4><p class="text-xs text-secondary leading-relaxed">Degradación de componentes por condiciones extremas de operación sin mantenimiento predictivo especializado.</p></div></div><div class="flex items-start gap-6"><div class="w-10 h-10 rounded bg-primary/10 flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg></div><div><h4 class="text-primary sf-bold uppercase tracking-widest mb-2 text-sm">Incertidumbre Técnica</h4><p class="text-xs text-secondary leading-relaxed">Falta de trazabilidad y certificación en reparaciones críticas que comprometen la seguridad faena.</p></div></div></div></div><div class="w-full lg:w-1/2 bg-white/10 backdrop-blur-md p-10 lg:p-16 rounded-3xl border border-white/20 hover:bg-white/20 transition-all relative group overflow-hidden shadow-xl"><h3 class="text-xl sf-bold text-primary uppercase tracking-widest mb-10 border-b border-primary/20 pb-4 inline-block">Solución StahlForm</h3><div class="space-y-12"><div class="flex items-start gap-6"><div class="w-10 h-10 rounded bg-primary/10 flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.954 11.954 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg></div><div><h4 class="text-primary sf-bold uppercase tracking-widest mb-2 text-sm">Estandarización de Calidad</h4><p class="text-xs text-secondary leading-relaxed">Protocolos de control rigurosos y materiales certificados según estándares internacionales.</p></div></div><div class="flex items-start gap-6"><div class="w-10 h-10 rounded bg-primary/10 flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a2 2 0 00-1.96 1.414l-.547 2.188a2 2 0 00.75 2.16l1.45 1.088a2 2 0 002.502-.24l1.503-1.503a2 2 0 00-.24-2.502l-1.088-1.45zm-14.856 0A2 2 0 015.594 14.881l2.387-.477a2 2 0 011.96 1.414l.547 2.188a2 2 0 01-.75 2.16l-1.45 1.088a2 2 0 01-2.502-.24L4.286 19.33a2 2 0 01.24-2.502l1.088-1.45z"></path></svg></div><div><h4 class="text-primary sf-bold uppercase tracking-widest mb-2 text-sm">Ingeniería Estructurada</h4><p class="text-xs text-secondary leading-relaxed">Metodologías de análisis de falla y rediseño activo para optimizar la resistencia y durabilidad.</p></div></div><div class="flex items-start gap-6"><div class="w-10 h-10 rounded bg-primary/10 flex items-center justify-center flex-shrink-0"><svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg></div><div><h4 class="text-primary sf-bold uppercase tracking-widest mb-2 text-sm">Auditoría y Certificación</h4><p class="text-xs text-secondary leading-relaxed">Soporte técnico documentas de trazabilidad técnica total en cada una de nuestras entregas.</p></div></div></div></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]), { __name: "CompanyBenefits" });
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CompanyBenefits = __nuxt_component_3;
      _push(`<!--[-->`);
...
//# sourceMappingURL=nuestra-empresa-R7Y1D9Cd.mjs.map
