import { _ as __nuxt_component_0 } from './nuxt-link-B4ezjIex.mjs';
...
import { u as useHead } from './composables-YN-Ot5N5.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-slate-50 py-12 lg:py-16" }, _attrs))}><div class="container mx-auto px-4 max-w-7xl"><div class="mb-12"><h1 class="text-3xl lg:text-4xl sf-bold sf-text-dark mb-2"> Resultados para: <span class="text-detail-primary">${ssrInterpolate(unref(searchQuery))}</span></h1><div class="title-accent"></div>`);
      if (unref(results).length > 0) {
        _push(`<p class="mt-2 sf-text-medium sf-light"> Se han encontrado ${ssrInterpolate(unref(results).length)} ${ssrInterpolate(unref(results).length === 1 ? "resultado" : "resultados")}. </p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (unref(results).length > 0) {
          ...
          if (item.type === "service") {
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<article class="flex flex-col md:flex-row w-full bg-white overflow-hidden gap-0 md:gap-6 h-auto md:h-[400px] shadow-sm rounded-xl transition-all duration-300 hover:shadow-lg"${_scopeId}><div class="w-full md:w-1/2 h-[250px] md:h-full overflow-hidden"${_scopeId}><img${ssrRenderAttr("src", item.src)}${ssrRenderAttr("alt", item.title)} class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"${_scopeId}></div><div class="flex flex-col p-6 md:p-8 w-full md:flex-1 gap-4 justify-center"${_scopeId}><span class="text-xs sf-bold uppercase tracking-wider text-detail-primary"${_scopeId}>Servicios</span><h2 class="sf-bold sf-text-dark text-xl lg:text-2xl group-hover:text-detail-primary transition-colors"${_scopeId}>${ssrInterpolate(item.title)}</h2><p class="sf-text-medium text-sm md:text-base sf-light leading-relaxed line-clamp-4"${_scopeId}>${ssrInterpolate(item.deck)}</p><div class="mt-4 flex items-center gap-2 text-detail-primary sf-bold text-sm"${_scopeId}> Ver Servicio `);
                  ...
                  return [
                    createVNode("article", { class: "flex flex-col md:flex-row w-full bg-white overflow-hidden gap-0 md:gap-6 h-auto md:h-[400px] shadow-sm rounded-xl transition-all duration-300 hover:shadow-lg" }, [
                      ...
                      createVNode("div", { class: "flex flex-col p-6 md:p-8 w-full md:flex-1 gap-4 justify-center" }, [
                        createVNode("span", { class: "text-xs sf-bold uppercase tracking-wider text-detail-primary" }, "Servicios"),
                        createVNode("h2", { class: "sf-bold sf-text-dark text-xl lg:text-2xl group-hover:text-detail-primary transition-colors" }, toDisplayString(item.title), 1),
                        createVNode("p", { class: "sf-text-medium text-sm md:text-base sf-light leading-relaxed line-clamp-4" }, toDisplayString(item.deck), 1),
                        createVNode("div", { class: "mt-4 flex items-center gap-2 text-detail-primary sf-bold text-sm" }, [
            ...
            _push(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_, _push2, _parent2, _scopeId) => {
                if (_push2) {
                  _push2(`<article class="flex flex-col md:flex-row w-full bg-white overflow-hidden gap-0 md:gap-6 h-auto md:h-[400px] shadow-sm rounded-xl transition-all duration-300 hover:shadow-lg"${_scopeId}><div class="w-full md:w-1/2 h-[250px] md:h-full overflow-hidden"${_scopeId}><img${ssrRenderAttr("src", item.src)}${ssrRenderAttr("alt", item.title)} class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"${_scopeId}></div><div class="flex flex-col p-6 md:p-8 w-full md:flex-1 gap-4 justify-center"${_scopeId}><span class="text-xs sf-bold uppercase tracking-wider text-detail-primary"${_scopeId}>Proyecto Destacado</span><h2 class="sf-bold sf-text-dark text-xl lg:text-2xl group-hover:text-detail-primary transition-colors"${_scopeId}>${ssrInterpolate(item.title)}</h2><p class="sf-text-medium text-sm md:text-base sf-light leading-relaxed line-clamp-4"${_scopeId}>${ssrInterpolate(item.description)}</p><div class="mt-4 flex items-center gap-2 text-detail-primary sf-bold text-sm"${_scopeId}> Ver en Proyectos `);
                  _push2(ssrRenderComponent(_component_Icon, { name: "heroicons:arrow-right" }, null, _parent2, _scopeId));
                  _push2(`</div></div></article>`);
                } else {
                  return [
                    createVNode("article", { class: "flex flex-col md:flex-row w-full bg-white overflow-hidden gap-0 md:gap-6 h-auto md:h-[400px] shadow-sm rounded-xl transition-all duration-300 hover:shadow-lg" }, [
                      ...
                      createVNode("div", { class: "flex flex-col p-6 md:p-8 w-full md:flex-1 gap-4 justify-center" }, [
                        createVNode("span", { class: "text-xs sf-bold uppercase tracking-wider text-detail-primary" }, "Proyecto Destacado"),
                        createVNode("h2", { class: "sf-bold sf-text-dark text-xl lg:text-2xl group-hover:text-detail-primary transition-colors" }, toDisplayString(item.title), 1),
                        createVNode("p", { class: "sf-text-medium text-sm md:text-base sf-light leading-relaxed line-clamp-4" }, toDisplayString(item.description), 1),
                        createVNode("div", { class: "mt-4 flex items-center gap-2 text-detail-primary sf-bold text-sm" }, [
        ...
        _push(`<h3 class="text-2xl sf-bold sf-text-dark mb-2">No se encontraron resultados</h3><p class="sf-text-medium sf-light"> Prueba con otros t̩rminos de b̼squeda. </p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/",
...
//# sourceMappingURL=buscar-C_9-M4mx.mjs.map
