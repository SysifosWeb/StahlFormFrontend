...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DwXi2Liz.mjs')
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-industrial sf-text-light" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center min-h-screen bg-dark-primary text-white font-['Poppins']" }, _attrs))} data-v-fd036a0f><div class="text-center p-8" data-v-fd036a0f><h1 class="text-9xl sf-bold text-detail-primary mb-4 animate-bounce" data-v-fd036a0f> 404 </h1><h2 class="text-3xl md:text-4xl font-semibold mb-6" data-v-fd036a0f> ¡Vaya! Página no encontrada </h2><p class="text-lg text-white/70 mb-10 max-w-md mx-auto" data-v-fd036a0f> Parece que el camino que buscabas no existe o ha sido movido. No te preocupes, puedes volver al inicio. </p><button class="bg-detail-primary hover:bg-red-700 text-white sf-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center gap-2 mx-auto" data-v-fd036a0f> Volver al Inicio </button></div><div class="fixed top-20 left-10 w-32 h-32 bg-detail-primary/10 rounded-full blur-3xl pointer-events-none" data-v-fd036a0f></div><div class="fixed bottom-20 right-10 w-48 h-48 bg-detail-primary/5 rounded-full blur-3xl pointer-events-none" data-v-fd036a0f></div></div>`);
    };
  }
};
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-fd036a0f"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
