...
const _sfc_main$1 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "secondary-header-container relative overflow-hidden flex items-center bg-primary font-sans" }, _attrs))} data-v-5d7b4fd9><div class="absolute inset-0 z-0" data-v-5d7b4fd9><img${ssrRenderAttr("src", unref(headerBg))} alt="Banner Industrial" class="w-full h-full object-cover object-[50%_25%] brightness-110 mix-blend-luminosity opacity-80" data-v-5d7b4fd9><div class="absolute inset-0 bg-primary/40" data-v-5d7b4fd9></div><div class="absolute inset-0 bg-gradient-to-r from-primary via-primary/60 to-transparent opacity-95" data-v-5d7b4fd9></div></div><div class="w-full relative z-10 custom-container flex items-center h-full" data-v-5d7b4fd9><div class="border-l-[3px] border-accent pl-6 lg:pl-8 py-2 max-w-4xl" data-v-5d7b4fd9><h1 class="text-3xl md:text-5xl lg:text-5xl font-black text-white uppercase tracking-tight leading-tight drop-shadow-2xl" data-v-5d7b4fd9>${__props.title ?? ""}</h1></div></div></header>`);
    };
  }
};
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-5d7b4fd9"]]);
const _sfc_main = {
  __name: "secondary",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=secondary-c3cwQnGa.mjs.map
