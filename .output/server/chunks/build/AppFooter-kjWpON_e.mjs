...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "fixed top-0 left-0 w-full z-[1002] bg-transparent py-6" }, _attrs))} data-v-e6429123><div class="custom-container flex items-center justify-between" data-v-e6429123>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", unref(logoStahlForm))} alt="StahlForm Logo" class="h-10 lg:h-20 w-auto group-hover:scale-105 transition-transform duration-300" data-v-e6429123${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
      ...
      _push(`<div class="hidden lg:flex items-center gap-10 ml-auto" data-v-e6429123><ul class="flex items-center gap-4" data-v-e6429123><!--[-->`);
      ssrRenderList([
        { to: "/", label: "INICIO" },
      ...
      _push(`<!--]--></ul></div><button class="lg:hidden text-accent focus:outline-none flex items-center justify-center transition-transform hover:scale-110 active:scale-95" aria-label="Menu" data-v-e6429123>`);
      if (!isMenuOpen.value) {
        _push(`<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-v-e6429123><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" data-v-e6429123></path></svg>`);
      } else {
        _push(`<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-v-e6429123><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-e6429123></path></svg>`);
      }
      _push(`</button></div>`);
      if (isMounted.value && isMenuOpen.value) {
        _push(`<div class="fixed inset-0 z-[2000] flex flex-col p-8 overflow-hidden mobile-menu-panel" data-v-e6429123><div class="absolute inset-0 technical-grid opacity-20 pointer-events-none" data-v-e6429123></div><div class="flex items-center justify-between relative z-10 mb-20" data-v-e6429123>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/",
          onClick: closeMenu
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", unref(logoStahlForm))} alt="StahlForm Logo" class="h-8 w-auto" data-v-e6429123${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
                  src: unref(logoStahlForm),
        ...
        _push(`<button class="text-accent hover:scale-110 transition-transform" data-v-e6429123><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-v-e6429123><path stroke-linecap="square" stroke-linejoin="inherit" stroke-width="0.8" d="M6 18L18 6M6 6l12 12" data-v-e6429123></path></svg></button></div><ul class="flex-grow flex flex-col justify-center space-y-12 relative z-10 px-4" data-v-e6429123><!--[-->`);
        ssrRenderList([
          { to: "/", label: "INICIO" },
          { to: "/nuestra-empresa", label: "NOSOTROS" },
          { to: "/servicios", label: "SERVICIOS" },
          ...
          _push(`<li class="relative" data-v-e6429123>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: item.to,
        ...
        _push(`<!--]--></ul><div class="mt-auto relative z-10 border-t border-white/10 pt-10 pb-4 space-y-4 flex flex-col items-center" data-v-e6429123><p class="text-[10px] text-center uppercase tracking-[0.3em] leading-tight text-gray-400 font-bold max-w-xs mx-auto" data-v-e6429123> CAPACIDAD TÉCNICA AL <span class="text-accent" data-v-e6429123>SERVICIO</span> DE OPERACIONES CRÍTICAS </p><div class="flex justify-center gap-8 mt-12" data-v-e6429123><a href="#" class="text-white opacity-60 hover:opacity-100 hover:text-accent transition-all" data-v-e6429123><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" data-v-e6429123><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" data-v-e6429123></path></svg></a><a href="https://www.instagram.com/stahlform_pyc?utm_source=qr&amp;igsh=MWQ2cnZxc2Mybnk5cQ==" target="_blank" class="text-white opacity-60 hover:opacity-100 hover:text-accent transition-all" data-v-e6429123><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" data-v-e6429123><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" data-v-e6429123></path></svg></a><a href="https://www.facebook.com/share/18F7fTkJD5/" target="_blank" class="text-white opacity-60 hover:opacity-100 hover:text-accent transition-all" data-v-e6429123><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" data-v-e6429123><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" data-v-e6429123></path></svg></a><a href="https://www.tiktok.com/@maestranza_stahlform?_r=1&amp;_t=ZS-95LP2FgXnyC" target="_blank" class="text-white opacity-60 hover:opacity-100 hover:text-accent transition-all" data-v-e6429123><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" data-v-e6429123><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 2.12-.91 4.1-2.4 5.56-1.69 1.66-3.95 2.62-6.33 2.58-2.61-.04-5.01-1.36-6.52-3.41-1.31-1.78-1.84-4.08-1.43-6.28.39-2.12 1.6-3.97 3.32-5.16 1.78-1.23 3.99-1.66 6.08-1.29v4.06c-1.36-.45-2.93-.34-4.14.4-1.07.65-1.8 1.79-1.99 3.03-.23 1.49.27 3.01 1.28 4.09 1.05 1.13 2.6 1.71 4.14 1.53 1.42-.16 2.66-.99 3.35-2.22.42-.75.64-1.61.64-2.48.02-4.99.01-9.98.01-14.97-.02-.02-.04-.04-.06-.06z" data-v-e6429123></path></svg></a></div><p class="text-[9px] uppercase tracking-[0.4em] text-gray-500 leading-tight" data-v-e6429123>© 2026 StahlForm</p></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</nav>`);
...
//# sourceMappingURL=AppFooter-kjWpON_e.mjs.map
