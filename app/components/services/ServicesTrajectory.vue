<template>
  <section class="relative w-full bg-[#eaeef3] py-12 lg:py-24 overflow-hidden font-sans border-none">
    ...
    <div class="absolute inset-0 z-0">
        <img src="~/assets/img/Kevin_torno.png" alt="Workshop Backdrop" class="w-full h-full object-cover opacity-10 grayscale mix-blend-multiply" />
    ...
    <div class="custom-container relative z-10 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
      ...
      <div class="w-full lg:w-1/2">
         ...
         <div class="space-y-6 text-gray-600 sf-light leading-relaxed text-base lg:text-lg border-l border-accent/20 pl-8">
            <p>
      ...
      <div class="w-full lg:w-1/2 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-center justify-center">
         ...
         <!-- Counter 1 -->
         <div class="flex flex-col items-center text-center p-8 background-medium rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-500 group">
