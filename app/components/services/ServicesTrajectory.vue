...
<template>
   <section class="relative w-full bg-[#eaeef3] py-12 lg:py-24 overflow-hidden font-sans border-none">
      ...
      <div class="absolute inset-0 z-0">
         <img src="~/assets/img/Kevin_torno.png" alt="Workshop Backdrop"
            class="w-full h-full object-cover opacity-10 grayscale mix-blend-multiply" />
         <div class="absolute inset-0 bg-gradient-to-br from-white/60 via-transparent to-transparent"></div>
      </div>

      <!-- Large Branding Shapes -->
      <div
         class="absolute -left-24 -bottom-24 w-[600px] h-[800px] z-0 opacity-10 pointer-events-none transform -rotate-12">
      ...
      <div class="custom-container relative z-10 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
         ...
         <div class="w-full lg:w-1/2">
            ...
            <div
               class="space-y-6 text-gray-600 sf-light leading-relaxed text-base lg:text-lg border-l border-accent/20 pl-8">
               <p>
                  En <span class="text-primary sf-bold">StahlForm</span>, cada servicio está respaldado por un riguroso
                  análisis de Ingeniería. No aplicamos soluciones genéricas; desarrollamos estrategias específicas para
                  los desafíos operativos de cada cliente.
               </p>
               <p>
                  Nuestra capacidad de integrar <span class="text-primary sf-bold">fotogrametría, escaneo 3D y
                     simulaciones de carga</span> nos permite entregar componentes con una precisión milimétrica,
                  reduciendo los tiempos de parada y optimizando la vida útil de sus equipos críticos.
               </p>
            </div>
         </div>

         <!-- Right Column: Numerical Counters (White Clean Style) -->
         <div class="w-full lg:w-1/2 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-center justify-center">
