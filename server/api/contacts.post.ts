...
export default defineEventHandler(async (event) => {
  try {
    ...
    // Extraer campos y archivo del FormData
      ...
      html: `
        <div style="font-family: 'Poppins', 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
          ...
          <div style="padding: 30px; background-color: #f9f9f9; border: 1px solid #eaeef3;">
            ...
            ${fileAttachment ? `<p style="font-size: 14px; color: #888;">El usuario adjuntó un documento asociado al requerimiento.</p>` : ''}
          </div>
    ...
    const clientMailOptions = {
      from: `"StahlForm Core Ingeniería" <${smtpUser}>`,
      to: email,
      ...
      html: `
        <div style="font-family: 'Poppins', 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1a1a1a;">
          <div style="background-color: #1a1a1a; padding: 40px 30px; text-align: center; border-bottom: 4px solid #c8d400;">
            ...
            <p style="color: #c8d400; margin: 10px 0 0 0; font-size: 12px; letter-spacing: 4px; text-transform: uppercase;">Core Ingeniería</p>
          </div>
          ...
          <div style="padding: 40px 30px; background-color: #ffffff; border: 1px solid #eaeef3; border-top: none;">
            ...
            <p style="color: #4a4a4a; line-height: 1.6; font-size: 15px;">
              Hemos recibido exitosamente su requerimiento técnico en nuestra plataforma. Nuestro equipo de ingeniería realizará una evaluación preliminar de sus activos basados en lo ingresado.
            </p>
            ...
            <div style="background-color: #eaeef3; border-left: 4px solid #003e49; padding: 15px 20px; margin: 25px 0;">
               <p style="margin: 0; color: #003e49; font-weight: 600; font-size: 14px;">
                 ⏱️ Tiempo estimado de Respuesta Técnica: <span style="color: #1a1a1a;">Menos de 24 horas.</span>
               </p>
            </div>

            <p style="color: #4a4a4a; line-height: 1.6; font-size: 15px;">
               Agradecemos la confianza en StahlForm. Un especialista se pondrá en contacto pronto de manera directa.
            </p>
            
            <div style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #eaeef3; font-size: 13px; color: #888;">
              <p style="margin: 5px 0; font-weight: 500; color: #003e49;">StahlForm - Ingeniería & Ventas</p>
              <p style="margin: 5px 0;">Email: contacto@stahlform.cl</p>
              <p style="margin: 5px 0;">Asistencia Crítica: +56 2 2345 6789</p>
            </div>
          </div>
          
          <div style="background-color: #1a1a1a; padding: 20px; text-align: center;">
            <p style="color: #888; font-size: 10px; margin: 0; font-family: monospace; letter-spacing: 1px;">S-TLFRM // SYS_READY - ESTE ES UN MENSAJE AUTOMÁTICO</p>
          </div>
        </div>
      `
    }
